...
- **Hạn chế sửa System Prompt:** Khi sửa tính năng hoặc fix các issue cũ, hạn chế tối đa việc thay đổi System Prompt. Hãy ưu tiên xử lý và giải quyết vấn đề bằng logic code.
