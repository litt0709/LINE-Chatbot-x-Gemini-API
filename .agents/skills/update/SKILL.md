...
1. **Lấy dữ liệu (Fetch Data):**
   ...
   - Trích xuất danh sách `audit_keywords`, `missed_link_requests`, `missed_topics`, `missed_entities`, và `missed_proactive_keywords` từ các log gần đây.
...
5. **Báo cáo (Report):**
   - Tóm tắt lại những từ khóa, cụm từ xin link, chủ đề mới, và trigger words nghe lén nào đã được update vào hệ thống.
