...
- **System 2 (Deep Reasoning)**: Khi phát hiện câu hỏi mang tính phân tích chuyên sâu, lập kế hoạch, hoặc có tâm trạng phức tạp, hệ thống tự động switch sang model có khả năng Chain-of-Thought (như `deepseek-v4-pro` / `R2`).
